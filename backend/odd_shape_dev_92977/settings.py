"""
Django settings for odd_shape_dev_92977 project.
...
ROOT_URLCONF = 'odd_shape_dev_92977.urls'
...
WSGI_APPLICATION = 'odd_shape_dev_92977.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_shape_dev_92977 API",
    "DESCRIPTION": "API documentation for odd_shape_dev_92977 App",
    "VERSION": "v1",
}
